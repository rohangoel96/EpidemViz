...
function sunburst_colors(n){
	...
	var colores_g = ["#3366cc", "#dc3912", "#ff9900", "#109618", "#990099", "#632c04", "#dd4477", "#66aa00", "#b82e2e", "#5a6570", "#994499", "#40d1c0", "#aaaa11", "#6633cc", "#e67300", "#8b0707", "#651067", "#329262", "#015114", "#3b3eac", "#222222", "#800080", "#008000", "#E6334C", "#800000", "#008080"];
	if(n<=25){
		return colores_g.slice(0, n);	
	} else {
		return generateDistinctColors(n)
