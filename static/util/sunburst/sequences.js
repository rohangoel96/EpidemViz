...
function initSunburst(data, colorData){
    ...
    function createVisualization(json) {
      ...
      var path = vis.data([json]).selectAll("#sunburstchart path")
          .data(nodes)
    ...
    function updateBreadcrumbs(nodeArray, percentageString) {
      ...
      entering.append("svg:text")
          ...
          .text(function(d) { return (d.name.length > 13 ? d.name.substr(0, 11)+'...' : d.name).replace(new RegExp('_', 'g'), "-"); });
    ...
    function drawLegend() {
      ...
      g.append("svg:text")
          ...
          .attr("dy", "0.35em")
          .attr("text-anchor", "middle")
          .text(function(d) { return d.key.replace(new RegExp('_', 'g'), "-"); });
    }
